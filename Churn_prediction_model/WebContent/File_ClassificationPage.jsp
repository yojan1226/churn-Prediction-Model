   ...
   <body class="dashboard dashboard_1">
      <div class="full_container">
         <div class="inner_container">
			...
			<tr>
			<td width="30%"><label for="txt_Uname">Select Train File</label></td>
		    <td width="30%" >
<select class="custom-select d-block form-control"
													id="person" name="file1" required
													data-error="Please select File">
													<option disabled selected>Select Training File</option>
													<option value="Train.arff">Train.arff</option>
													
												</select>		    
</td>
		    <td width="30%"><label for="txt_Uname">Select Test File</label></td>
		    <td width="30%" >
<select class="custom-select d-block form-control"
													id="person" name="file2" required
													data-error="Please select File">
													<option disabled selected>Select Testing File</option>
													<option value="Test.arff">Test.arff</option>
													
												</select>		    
</td>
		  <td   align="left" ><input type="submit"  name="btn_Submit" id="btn_Submit" Value="Process"><br>
			</td>
			</tr>
