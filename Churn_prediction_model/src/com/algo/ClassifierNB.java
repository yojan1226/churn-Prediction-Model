...
//Load weka path
			...
			evaluation.crossValidateModel(nb, instTest, 10, new Random(1));
...
//                acc=(correctClass / (records) * 100);
//                System.out.println("Accuracy : " + acc);
			double acc = (evaluation.correct() / (records) * 100);
			System.out.println("NB Accuracy : " + acc);
			...
			System.out.println("fMeasure : " + evaluation.fMeasure(0));
			 ...
			 st1.executeUpdate("update accuracydata set Accuracy_data='"+acc+"',Precision_data='"+evaluation.precision(0)+"', Recall_data='"+evaluation.recall(0)+"',F_measure_data='"+evaluation.fMeasure(0)+"' where Algorithm_Name='NBClass'");
        } catch (Exception e) {
            e.printStackTrace();
        }
